...
public class DefendantJsonMapper {
    ...
    public JsonObject map(Party defendantFromResponse, TheirDetails defendantFromClaim, String defendantsEmail) {
        JsonObjectBuilder jsonObjectBuilder = new NullAwareJsonObjectBuilder()
            ...
            .add("address", defendantFromResponse.getAddress() != null ? addressMapper.map(defendantFromResponse.getAddress()) : null)
            ...
            .add("addressAmended", defendantFromResponse.getAddress() != null ? isAddressAmended(defendantFromResponse, defendantFromClaim) : false)
