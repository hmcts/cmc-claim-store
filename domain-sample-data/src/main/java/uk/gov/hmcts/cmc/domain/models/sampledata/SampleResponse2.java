...
public abstract class SampleResponse2<T extends SampleResponse2<T>> {
    ...
    public static class FullAdmission extends SampleResponse2<FullAdmission> {
    ...
    public static class PartAdmission extends SampleResponse2<PartAdmission> {
    ...
    public static class FullDefence extends SampleResponse2<FullDefence> {
    ...
    public SampleResponse2<T> withMediation(YesNoOption freeMediationOption) {
        this.freeMediationOption = freeMediationOption;
        return this;
    }

    public SampleResponse2<T> withMoreTimeNeededOption(YesNoOption moreTimeNeededOption) {
        this.moreTimeNeededOption = moreTimeNeededOption;
        return this;
    }

    public SampleResponse2<T> withDefendantDetails(Party sampleDefendantDetails) {
        this.defendantDetails = sampleDefendantDetails;
        return this;
    }

    public SampleResponse2<T> withStatementOfTruth(String signerName, String signerRole) {
