...
public interface ClaimRepository {
    ...
    @SqlQuery("SELECT * FROM claim WHERE id between (SELECT id FROM claim where reference_number ='048MC334') and (SELECT id FROM claim where reference_number ='049MC361') order by id asc")
