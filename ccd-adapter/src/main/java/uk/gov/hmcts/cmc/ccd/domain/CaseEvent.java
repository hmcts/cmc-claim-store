...
public enum CaseEvent {
    ...
    DISPUTE_RESPONSE_SUBMITTED("DisputesAll"),
    ALREADY_PAID_RESPONSE_SUBMITTED("StatesPaid"),
    FULL_ADMISSION_RESPONSE_SUBMITTED("AdmitAll"),
    PART_ADMISSION_RESPONSE_SUBMITTED("AdmitPart"),
