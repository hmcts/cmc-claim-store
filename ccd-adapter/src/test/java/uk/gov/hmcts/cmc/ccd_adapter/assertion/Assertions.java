...
import uk.gov.hmcts.cmc.ccd_adapter.assertion.claimantresponse.CourtDeterminationAssert;
import uk.gov.hmcts.cmc.ccd_adapter.assertion.claimantresponse.ResponseAcceptationAssert;
import uk.gov.hmcts.cmc.ccd_adapter.assertion.claimantresponse.ResponseRejectionAssert;
import uk.gov.hmcts.cmc.ccd_adapter.assertion.defendant.PaymentIntentionAssert;
import uk.gov.hmcts.cmc.ccd_adapter.assertion.defendant.ResponseAssert;
import uk.gov.hmcts.cmc.ccd_adapter.assertion.defendant.statementofmeans.BankAccountAssert;
import uk.gov.hmcts.cmc.ccd_adapter.assertion.defendant.statementofmeans.ChildAssert;
import uk.gov.hmcts.cmc.ccd_adapter.assertion.defendant.statementofmeans.CourtOrderAssert;
import uk.gov.hmcts.cmc.ccd_adapter.assertion.defendant.statementofmeans.DebtAssert;
import uk.gov.hmcts.cmc.ccd_adapter.assertion.defendant.statementofmeans.EmployerAssert;
import uk.gov.hmcts.cmc.ccd_adapter.assertion.defendant.statementofmeans.ExpenseAssert;
import uk.gov.hmcts.cmc.ccd_adapter.assertion.defendant.statementofmeans.IncomeAssert;
import uk.gov.hmcts.cmc.ccd_adapter.assertion.defendant.statementofmeans.LivingPartnerAssert;
import uk.gov.hmcts.cmc.ccd_adapter.assertion.defendant.statementofmeans.PriorityDebtAssert;
