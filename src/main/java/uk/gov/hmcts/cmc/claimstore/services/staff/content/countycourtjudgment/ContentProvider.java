...
public class ContentProvider {
    ...
    @Autowired
    public ContentProvider(AmountContentProvider amountContentProvider) {
        this.amountContentProvider = amountContentProvider;
    }

    public Map<String, Object> createContent(Claim claim) {
        requireNonNull(claim);
        return Collections.singletonMap("ccj", new CCJContent(claim, amountContentProvider.create(claim)));
    }
}
