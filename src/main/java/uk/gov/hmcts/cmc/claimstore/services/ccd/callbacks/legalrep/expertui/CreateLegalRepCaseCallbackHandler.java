package uk.gov.hmcts.cmc.claimstore.services.ccd.callbacks.legalrep.expertui;
...
@Service
public class CreateLegalRepCaseCallbackHandler extends CallbackHandler {

    private static final List<CaseEvent> EVENTS = Collections.singletonList(CREATE_LEGAL_REP_CASE);
    private static final List<Role> ROLES = ImmutableList.of(SOLICITOR, CASEWORKER);
    ...
    @Autowired
    public CreateLegalRepCaseCallbackHandler(
