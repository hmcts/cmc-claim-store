...
@Service
public class PaidInFullStaffEmailContentProvider
    ...
    @Autowired
    public PaidInFullStaffEmailContentProvider(
    ...
    public EmailContent createContent(Map<String, Object> input) {
        return new EmailContent(
            evaluateTemplate(emailTemplates.getPaidInFullEmailSubject(), input),
            evaluateTemplate(emailTemplates.getPaidInFullEmailBody(), input)
        );
    }
