...
@Service
public class CreateHelpWithFeesClaimCallbackHandler extends CallbackHandler {
    private static final List<CaseEvent> EVENTS = Collections.singletonList(CREATE_HWF_CASE);
    ...
    @Autowired
    public CreateHelpWithFeesClaimCallbackHandler(
