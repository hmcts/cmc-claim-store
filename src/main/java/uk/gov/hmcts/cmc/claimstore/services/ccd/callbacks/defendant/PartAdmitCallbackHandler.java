...
import static uk.gov.hmcts.cmc.ccd.domain.CaseEvent.PART_ADMISSION;
import static uk.gov.hmcts.cmc.claimstore.services.ccd.Role.CASEWORKER;

@Service
public class PartAdmitCallbackHandler extends CallbackHandler {
    private static final List<Role> ROLES = ImmutableList.of(CASEWORKER);
    private static final List<CaseEvent> EVENTS = Collections.singletonList(PART_ADMISSION);

    private final CaseDetailsConverter caseDetailsConverter;
    private final IntentionToProceedNotificationService intentionToProceedNotificationService;

    @Autowired
    public PartAdmitCallbackHandler(CaseDetailsConverter caseDetailsConverter,
