...
public class DocAssemblyTemplateBodyMapper {
    ...
    public DocAssemblyTemplateBody changeContactBody(CCDCase ccdCase) {
        ...
        return DocAssemblyTemplateBody.builder()
            ...
            .hasContactAddressChanged(contactChangeContent.getIsCorrespondenceAddressModified() == YES)
            .claimantEmailRemoved(contactChangeContent.getPrimaryEmailRemoved() == YES)
            .claimantPhoneRemoved(contactChangeContent.getTelephoneRemoved() == YES)
            .claimantContactAddressRemoved(contactChangeContent.getCorrespondenceAddressRemoved() == YES)
            .build();
    }
