...
import static uk.gov.hmcts.cmc.ccd.domain.CaseEvent.ALREADY_PAID;
import static uk.gov.hmcts.cmc.claimstore.services.ccd.Role.CASEWORKER;

@Service
public class StatesPaidCallbackHandler extends CallbackHandler {
    private static final List<Role> ROLES = ImmutableList.of(CASEWORKER);
    private static final List<CaseEvent> EVENTS = Collections.singletonList(ALREADY_PAID);

    private final CaseDetailsConverter caseDetailsConverter;
    private final IntentionToProceedNotificationService intentionToProceedNotificationService;

    @Autowired
    public StatesPaidCallbackHandler(CaseDetailsConverter caseDetailsConverter,
