...
public class DocumentPublishService {
    ...
    public CCDCase publishDocuments(
        ...
        logger.info("Received oconForm for claim id {} oconForm documentUrl {} oconForm documentBinaryUrl {} oconForm documentFileName {}",
             claim.getId(), oconForm.getDocumentUrl(), oconForm.getDocumentBinaryUrl(), oconForm.getDocumentFileName());
