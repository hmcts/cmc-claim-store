...
public class DocumentPublishService {
    ...
    public CCDCase publishDocuments(
        ...
        var coverDoc = printableDocumentService.process(coverLetter, authorisation, false);
        if (!disableN9Form && featureFlag) {
            ...
            ocon9Doc = printableDocumentService.process(ocon9Letter, authorisation, false);
        }
        ...
        var formDoc = printableDocumentService.process(oconForm, authorisation, false);
        if (featureFlag) {
