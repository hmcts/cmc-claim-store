...
public class TransferCaseDocumentPublishService {
    ...
    public CCDCase publishLetterToDefendant(CCDCase ccdCase, String authorisation, Claim claim) {
        ...
        CCDDocument defendantLetter = docAssemblyService.generateDocument(ccdCase,
            ...
            .toBuilder()
            .documentFileName(buildNoticeOfTransferLetterFileName(ccdCase, TO_COURT_FOR_DEFENDANT))
            .build();
