...
public class DefendantOperationService {
    ...
    @Autowired
    public DefendantOperationService(ClaimIssuedCitizenActionsHandler claimIssuedCitizenActionsHandler) {
    ...
    public Claim notify(Claim claim, String pin, String submitterName, String authorisation) {
        ...
        claimIssuedCitizenActionsHandler.sendDefendantNotification(issuedEvent);
