...
public abstract class BaseCCJPdfTest extends BasePdfTest {
    ...
    protected void assertClaimAmountDetails(Claim createdCase, String pdfAsText) {
    ...
    protected void assertTotalAmount(Claim createdCase, String pdfAsText, AmountContent amountContent) {
        ClaimData claimData = createdCase.getClaimData();
    ...
    protected void assertDeclaration(Claim createdCase, String pdfAsText) {
