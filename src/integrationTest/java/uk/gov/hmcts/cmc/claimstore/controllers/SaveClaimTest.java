...
public class SaveClaimTest extends BaseSaveTest {
    ...
    public void shouldReturnNewlyCreatedClaim() throws Exception {
        ...
        Claim updated = getClaimOperation.retrieveClaim(claimData.getExternalId().toString(), AUTHORISATION_TOKEN);
    ...
    public void shouldFailWhenStaffNotificationFails() throws Exception {
        ...
        Claim updated = getClaimOperation.retrieveClaim(claim.getExternalId(), AUTHORISATION_TOKEN);
    ...
    public void shouldRetrySendNotifications() throws Exception {
        ...
        getClaimOperation.retrieveClaim(claim.getExternalId(), AUTHORISATION_TOKEN);
    ...
    public void shouldSendStaffNotificationsForCitizenClaimIssuedEvent() throws Exception {
        ...
        getClaimOperation.retrieveClaim(savedClaim.getExternalId(), AUTHORISATION_TOKEN);
