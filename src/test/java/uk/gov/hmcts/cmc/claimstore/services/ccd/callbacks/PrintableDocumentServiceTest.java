...
class PrintableDocumentServiceTest {
    ...
    @BeforeEach
    void setUp() {
        printableDocumentService = new PrintableDocumentService(unsecuredDocumentManagementService);
    }
    ...
    void shouldDownloadDocumentFromDocumentManagement() {
        ...
        verify(unsecuredDocumentManagementService, times(1)).downloadDocument(
            anyString(),
    ...
    void shouldThrowExceptionIfDownloadUrlIsWrong() {
        ...
        when(unsecuredDocumentManagementService.downloadDocument(
            anyString(),
