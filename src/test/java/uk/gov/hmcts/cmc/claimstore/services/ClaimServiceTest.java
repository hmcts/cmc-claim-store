...
public class ClaimServiceTest {
    ...
    public void getClaimByIdShouldCallRepositoryWhenValidClaimIsReturned() {
        ...
        when(caseRepository.getById(eq(CLAIM_ID))).thenReturn(result);
    ...
    public void getClaimByIdShouldThrowNotFoundException() {
        ...
        when(caseRepository.getById(eq(CLAIM_ID))).thenReturn(Optional.empty());
    ...
    public void getClaimByLetterHolderIdShouldCallRepositoryWhenValidClaimIsReturned() {
        ...
        when(caseRepository.getByLetterHolderId(eq(LETTER_HOLDER_ID))).thenReturn(result);
    ...
    public void getClaimByLetterHolderIdShouldThrowExceptionWhenClaimDoesNotExist() {
        ...
        when(caseRepository.getByLetterHolderId(eq(letterHolderId))).thenReturn(result);
    ...
    public void getClaimByExternalIdShouldThrowExceptionWhenClaimDoesNotExist() {
        ...
        when(caseDBI.getClaimByExternalId(eq(externalId), eq(AUTHORISATION))).thenReturn(result);
    ...
    public void saveClaimShouldFinishSuccessfully() {
        ...
        when(caseRepository.saveRepresented(
            eq(jsonApp),
            eq(USER_ID),
            eq(ISSUE_DATE),
        ...
        when(caseRepository.getById(eq(CLAIM_ID))).thenReturn(Optional.of(claim));
    ...
    public void saveClaimShouldThrowConflictExceptionForDuplicateClaim() {
        ...
        when(caseDBI.getClaimByExternalId(any(), anyString())).thenReturn(Optional.of(claim));
    ...
    public void requestMoreTimeToRespondShouldFinishSuccessfully() {
        ...
        when(caseDBI.getClaimByExternalId(eq(EXTERNAL_ID), anyString())).thenReturn(Optional.of(claim));
        ...
        verify(caseRepository, once()).requestMoreTime(eq(CLAIM_ID), eq(newDeadline));
    ...
    public void requestMoreTimeToRespondShouldThrowNotFoundExceptionWhenClaimNotFound() {
        when(caseDBI.getClaimByExternalId(eq(EXTERNAL_ID), anyString())).thenReturn(Optional.empty());
