...
class HWFHalfRemissionRejectedCallbackHandlerTest {
    @Rule
    public MockitoRule rule = MockitoJUnit.rule().strictness(Strictness.LENIENT);
    private static final String AUTHORISATION = "Bearer: aaaa";
    private HWFHalfRemissionRejectedCallbackHandler handler;
    ...
    @BeforeEach
    public void setUp() {
        handler = new HWFHalfRemissionRejectedCallbackHandler(caseDetailsConverter, deadlineCalculator, caseMapper,
