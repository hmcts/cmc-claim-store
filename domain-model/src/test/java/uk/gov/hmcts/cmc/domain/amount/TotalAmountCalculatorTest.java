        ...
        Claim claimStandardInterest = SampleClaim.builder()
            .withClaimData(
                SampleClaimData.builder()
                    ...
                    .withStanderdRateAndInterestDate(SampleInterestDate.submission())
                    .build()
            ).build();
        ...
        Claim claim = SampleClaim.builder()
            .withClaimData(
                SampleClaimData.builder()
                    .withAmount(SampleAmountBreakdown.validDefaults())
                    .withFeeAmount(TWENTY_POUNDS_IN_PENNIES)
                    .withInterest(SampleInterest.breakdownInterestBuilder()
                        .withInterestDate(SampleInterestDate.submissionToSubmission()).build())
                    .build()
            )
        ...
        Claim claimStandardInterest = SampleClaim.builder()
            .withClaimData(
                SampleClaimData.builder()
                    .withAmount(SampleAmountBreakdown.validDefaults())
                    .withFeeAmount(TWENTY_POUNDS_IN_PENNIES)
                    .withInterest(SampleInterest.standardWithSpecificInterestDate(SampleInterestDate.submission()))
                    .build()
            )
            .withIssuedOn(LocalDate.now())
            .build();
